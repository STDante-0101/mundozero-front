...
export function loadResume(
    ...
    html += '<h2 class="sectionTitle sectionTitle-cards">' + globalize.translate(titleLabel) + '</h2>';
    html += '<span class="material-icons chevron_right mz-section-chevron" aria-hidden="true"></span>';
    html += '</div>';
